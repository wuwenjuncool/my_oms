    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('install_date', models.CharField(max_length=50, verbose_name='\u5b89\u88c5\u65f6\u95f4')),
                ('ip', models.CharField(max_length=20, verbose_name='\u5b89\u88c5IP')),
                ('system_version', models.CharField(max_length=50, verbose_name=b'\xe5\xae\x89\xe8\xa3\x85\xe6\x93\x8d\xe4\xbd\x9c\xe7\xb3\xbb\xe7\xbb\x9f\xe7\x89\x88\xe6\x9c\xac')),
            ],
            options={
                'verbose_name_plural': '\u88c5\u673a\u8bb0\u5f55\u7ba1\u7406',
            },
        ),
        migrations.CreateModel(
            name='SystemInstall',
            fields=[
                ...
                ('profile', models.CharField(max_length=50, verbose_name='profile\u6587\u4ef6\u540d')),
            ],
            options={
